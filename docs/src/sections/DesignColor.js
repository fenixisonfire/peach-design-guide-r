  ...
  return (
    <div className="bs-docs-section">
      ...
      <p>
        ...
        <br></br>
        <p>
            <Image src="./../../assets/img-messaging.svg" rounded/>
        </p>
        ...
        <br></br>
        <p>
            <Image src="./../../assets/img-differentiation.svg" rounded/>
        </p>
        ...
        <br></br>
        <p>
            <Image src="./../../assets/img-hierarchy.svg" rounded/>
        </p>
        ...
        <br></br>
        <p>
            <Image src="./../../assets/img-accessibility.svg" rounded/>
        </p>
