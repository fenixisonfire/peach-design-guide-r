...
export default function DataVisTooltipLineM() {
    ...
    return (
        <div className="bs-docs-section">
            <h2 className="page-header">
                <Anchor id="datavistooltiplinem">Tooltip Line Multiple</Anchor>
            </h2>
            <p>
              The multiple line chart is frequently used for data investigation. It allows viewers to compare and correlate the trends of two or more variables.
